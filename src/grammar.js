...
// This function is provided by nearley, the parsing library used.  It is not implemented here.
function grammar(arg0) {
  throw new Error("Function not implemented.");
}

function repeat(arg0) {
  throw new Error("Function not implemented.");
}
// This function is provided by nearley, the parsing library used.  It is not implemented here.
function optional(command_separator) {
  throw new Error("Function not implemented.");
}

function alias(invalid_move_command, error) {
  throw new Error("Function not implemented.");
}

function repeat1(arg0) {
  throw new Error("Function not implemented.");
}
